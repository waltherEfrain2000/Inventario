...
function listWarehouses() {
  ...
  $.ajax({
      url: "/Inventario/app/modules/warehouses/controllers/list_Warehouses.php",
      type: "GET",
      dataType: "json",
...
function save_Warehouse() {
  ...
  $.ajax({
      url: '/Inventario/app/modules/warehouses/controllers/save_Warehouse.php',
      type: 'POST',
      data: {
          NombreBodega: name,
...
function loadWarehouseForEdit(id) {
  ...
  $.ajax({
      url: "/Inventario/app/modules/warehouses/controllers/list_Warehouse_For_Update.php?id=" + id,
      type: "GET",
      dataType: "json",
      success: function (response) {
...
function update_Warehouse(id) {
  ...
  $.ajax({
      url: '/Inventario/app/modules/warehouses/controllers/update_Warehouse.php',
      type: 'POST',
      data: {
          id: id,
          NombreBodega: name,
...
function handleDeleteWarehouse(id) {
  Swal.fire({
      ...
      if (result.isConfirmed) {
          $.post("/Inventario/app/modules/warehouses/controllers/disable_Warehouse.php", { action: "eliminar", id: id }, function (response) {
