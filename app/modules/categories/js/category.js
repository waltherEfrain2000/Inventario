            ...
            $("#table-style-hover").on("click", ".delete-btn", function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.post("/Inventario/app/modules/categories/controllers/disable_Categories.php", { action: "eliminar", id: id }, function (response) {
...
function loadCategoryForEdit(id) {
    $.ajax({
        url: "/Inventario/app/modules/categories/controllers/list_Category_For_Update.php?id=" + id,
        type: "GET",
        dataType: "json",
        success: function (response) {
...
function save_Categories() {
    ...
    $.ajax({
        url: '/Inventario/app/modules/categories/controllers/save_Categories.php',
        type: 'POST',
        data: {
...
function update_Category(id) {
    ...
    $.ajax({
        url: "/Inventario/app/modules/categories/controllers/update_Category.php",
        type: "POST",
        data: {
            id: id,
            categoriaNombre: name,
...
function listSubCategories() {
    ...
    $.ajax({
        url: "/Inventario/app/modules/categories/controllers/list_SubCategories.php",
        type: "GET",
        dataType: "json",
        success: function (response) {
            ...
            $("#table-subcategoria").on("click", ".delete-btn", function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.post("/Inventario/app/modules/categories/controllers/disable_SubCategories.php", { action: "eliminar", id: id }, function (response) {
                            let data = JSON.parse(response);
                            if (data.success) {
                                listSubCategories();
                            } else {
...
function save_SubCategories() {
    ...
    $.ajax({
        url: '/Inventario/app/modules/categories/controllers/save_SubCategories.php',
        type: 'POST',
        data: {
...
function loadSubCategoryForEdit(id) {
    $.ajax({
        url: "/Inventario/app/modules/categories/controllers/list_SubCategory_For_Update.php?id=" + id,
        type: "GET",
        dataType: "json",
        success: function (response) {
...
function update_SubCategory(id) {
    ...
    $.ajax({
        url: "/Inventario/app/modules/categories/controllers/update_SubCategory.php",
        type: "POST",
        data: {
            id: id,
            idCategoria: idCategoria,
